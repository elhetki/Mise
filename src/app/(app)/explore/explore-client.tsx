...
import { BOOKING_PLATFORMS } from '@/lib/restaurants'
...
function getUniqueCities(restaurants: Restaurant[]): string[] {
...
export default function ExploreClient({ restaurants }: ExploreClientProps) {
  const [query, setQuery] = useState('')
  const [selectedCity, setSelectedCity] = useState<string>('all')
  const [selectedPlatform, setSelectedPlatform] = useState<string>('all')
  const [selectedStatus, setSelectedStatus] = useState<string>('all')

  const ALL_CITIES = useMemo(() => getUniqueCities(restaurants), [restaurants])
  ...
  }, [restaurants, query, selectedCity, selectedPlatform, selectedStatus])
